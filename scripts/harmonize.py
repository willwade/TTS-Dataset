...
try:
    ...
    from langcodes.language import Language as LanguageClass
except ImportError:
...
def get_language_info(lang_code: str) -> Dict[str, Any]:
    ...
    try:
        ...
        if lang:
            result['language_name'] = lang.language_name() if hasattr(lang, 'language_name') else str(lang)
            ...
            if hasattr(lang, 'territory') and lang.territory:
                ...
                try:
                    ...
                    result['country_code'] = maximized.territory if hasattr(maximized, 'territory') else None
                except:
                    pass
